...
@section('content')
    ...
    <form method="post" action="" enctype="multipart/form-data">
        <div class="row">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div type="button" class="panel panel-default">
                                    <div class="panel-body" id="product_picture"
                                         style="width: 100%;background: #fdfdfd;border:2px dashed #8eb4cb;min-height: 250px;cursor: pointer;">
                    ...
                    <div class="box-body">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="product_weight" value="{{old('product_weight', '0')}}"
                                       class="form-control" min="0" step="0.1" id="product_weight">
                            </div>
                            <div class="form-group">
                                <label for="product_length" class="control-label">Length (in cm)</label>
                                <input type="number" name="product_length" value="{{old('product_length', '0')}}"
                                       class="form-control" min="0" step="0.1" id="product_length">
                            </div>
                            <div class="form-group">
                                <label for="product_width" class="control-label">Width (in cm)</label>
                                <input type="number" name="product_width" value="{{old('product_width', '0')}}"
                                       class="form-control" min="0" step="0.1" id="product_width">
                            </div>
                            <div class="form-group">
                                <label for="product_height" class="control-label">Height (in cm)</label>
                                <input type="number" name="product_height" value="{{old('product_height', '0')}}"
                                       class="form-control" min="0" step="0.1" id="product_height">
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="product_price" value="{{old('product_price', '0')}}"
                                           class="form-control" min="0" step="1" aria-describedby="sizing-addon2">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="sizing-addon2">Rp. </span>
                                    <input type="number" name="product_sale_price"
                                           value="{{old('product_sale_price', '0')}}" class="form-control" min="0"
                                           step="1"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="product_sale_period" value="{{old('product_sale_period')}}"
                                           class="form-control date" id="product_sale_period">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="product_sku" value="{{old('product_sku')}}"
                                       class="form-control" id="product_sku" required>
                            </div>
                            <div class="form-group">
                                <label for="product_stock" class="control-label">Stok</label>
                                <div class="input-group">
                                    <input type="number" name="product_stock" value="{{old('product_stock', '0')}}"
                                           class="form-control" min="0" step="1" aria-describedby="sizing-addon2">
                    ...
                    <div class="box-body">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="product_page_title" value="{{old('product_page_title')}}"
                                       class="form-control" id="product_page_title">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="product_meta_description"
                                       value="{{old('product_meta_description')}}" class="form-control"
                                       id="product_meta_description">
                            </div>
                            <div class="form-group">
                                <label for="product_meta_keywords" class="control-label">Meta Keywords</label>
                                <input type="text" name="product_meta_keywords" value="{{old('product_meta_keywords')}}"
                                       class="form-control" id="product_meta_keywords">
                            </div>
                        </fieldset>
                    ...
                    <div class="box-body">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <select name="related_product[]" class="form-control" id="related_product"
                                        multiple="multiple">
            ...
            <div class="col-md-8">
                <div class="box box-default box-solid">
                    {{--<div class="box-header with-border">Personalisasi</div>--}}
                    <div class="box-body">
                        <div class="form-group">
                            @forelse($personalisasi as $k => $v)
                                <div class="col-md-6">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="product_personalisasi[]"
                                                   value="{{$v->id}}">{{title_case($v->jenis)}}
                                            - {{title_case($v->name)}} &nbsp;
                                        </label>
                                    </div>
                                </div>
            ...
            <div class="col-md-4">
                <div class="box box-default">
                    <div class="box-header with-border">Action</div>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="publishe" class="control-label">Published?</label>
                            <div class="checkbox">
                                <label>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-flat btn-block pull-right">Simpan <i
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#product_sale_period').daterangepicker({
                timePicker: true,
